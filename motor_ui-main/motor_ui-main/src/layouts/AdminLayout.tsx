...
const navItems = [
  ...
  { label: "AI Intelligence Centre", icon: "neurology", path: "/admin/ai-intelligence" },
      ...
      <main className="flex-1 flex flex-col overflow-y-auto bg-background">
        <header className="h-16 bg-card border-b border-border flex items-center justify-between px-4 sm:px-8 sticky top-0 z-10 gap-2">
          <div className="flex items-center gap-2 sm:gap-4 min-w-0">
            ...
            <h1 className="text-base sm:text-lg font-bold text-foreground truncate">Admin Portal</h1>
          </div>
