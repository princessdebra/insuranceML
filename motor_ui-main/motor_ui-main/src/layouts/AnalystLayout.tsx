      ...
      <main className="flex-1 flex flex-col overflow-y-auto bg-background">
        <header className="h-16 bg-card border-b border-border flex items-center justify-between px-4 sm:px-8 sticky top-0 z-10 gap-2">
          <div className="flex items-center gap-2 sm:gap-4 min-w-0">
            ...
            <h1 className="text-base sm:text-lg font-bold text-foreground truncate">Analyst Portal</h1>
          </div>
          <div className="flex items-center gap-2 sm:gap-4 shrink-0">
            <Link
              to="/analyst/file-claim"
              className="flex items-center gap-2 px-3 sm:px-4 py-2 bg-primary text-primary-foreground rounded-lg text-xs sm:text-sm font-bold hover:bg-primary/90 transition-colors shadow-sm shadow-primary/20"
            >
